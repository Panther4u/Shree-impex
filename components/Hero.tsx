      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          ...
          <TextGenerateEffect
            ...
            className="text-center text-[30px] md:text-5xl lg:text-6xl text-black"
          />

          <p className="text-black text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-1xl text-gray">
            Thriving in this industry for over{" "}
            <span className="text-purple font-semibold">30 years</span>, delivering excellence and trust.
          </p>
